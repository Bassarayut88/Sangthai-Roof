...
// ============================================================
    ...
    function updateModelInfo() {
        ...
        if (val.startsWith("custom")) {
            ...
            let selectedText = select.options[select.selectedIndex] ? select.options[select.selectedIndex].text : '';
            let rMin = (typeof getProfileMinSpringRadius === 'function') ? getProfileMinSpringRadius(selectedText, val) : 35;
            
            let slopeText = "";
            if(minSlope > 0) slopeText = ` | แนะนำ Slope ≥ ${minSlope}°`;
            modelInfo.innerText = `✓ หน้ากว้าง: ${width} ม.${slopeText} | 📐 โค้งธรรมชาติ R ≥ ${rMin} ม.`;
